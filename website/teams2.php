...
<ul class="nav">
  ...
  <li>
    <a href="teams.php"><img src="../BE/images/bat.ico" width="25" height="25"> Team 1</a>
  </li>
  <li class="active">
    <a class="active" href="teams2.php"><img src="../BE/images/ball.ico" width="25" height="25"> Team 2</a>
  </li>
...
<div class="div2"><b style="color: white;">Select Team 2:-</b></div>
<div class="div1" style:"200px;">
    <h3 style="color: white;">select team 2:</h3>
    <form action="winning.html" method="post">
...
<script>
    function myFunction() {
        alert("You have succesfully selected Team 2");
    }
</script>
